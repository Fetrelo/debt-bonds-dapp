    ...
    <section className="mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-center gap-16 px-4 py-20 sm:px-6 sm:py-24">
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-dashed border-black/10 bg-white/40 p-5 dark:border-white/10 dark:bg-white/[0.02]">
            <div className="flex items-center justify-between">
              <span className="grid h-9 w-9 place-items-center rounded-xl border border-black/10 bg-white/70 text-base font-medium text-zinc-500 dark:border-white/10 dark:bg-white/5 dark:text-zinc-500">
                ◴
              </span>
              <span className="rounded-full border border-black/10 bg-white/60 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider text-zinc-500 dark:border-white/10 dark:bg-white/5 dark:text-zinc-400">
                Soon
              </span>
            </div>
            <div>
              <h3 className="text-base font-semibold text-zinc-500 dark:text-zinc-500">
                Issue a bond series
              </h3>
              <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-500">
                Create a new debt-bond series with custom coupon and maturity
                terms.
              </p>
            </div>
          </div>
